...
[Download v0.3.2](https://github.com/bigidulka/gdictate/releases/tag/v0.3.2) · [Project page](https://bigidulka.github.io/gdictate/) · [Release workflow](.github/workflows/release.yml)
...
Current release: [v0.3.2](https://github.com/bigidulka/gdictate/releases/tag/v0.3.2)

| Platform | Package |
|---|---|
| Linux portable | `gdictate_0.3.2_amd64.AppImage` |
| Debian / Ubuntu | `gdictate_0.3.2_amd64.deb` |
| Fedora / RPM | `gdictate-0.3.2-1.x86_64.rpm` |
| Arch / pacman | `gdictate-0.3.2-1-x86_64.pkg.tar.zst` |
| Windows installer | `gdictate_0.3.2_x64-setup.exe` |
| Windows MSI | `gdictate_0.3.2_x64_en-US.msi` |
...
```bash
git tag -a v0.3.2 -m "gdictate v0.3.2"
